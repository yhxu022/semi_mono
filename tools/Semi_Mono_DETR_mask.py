...
class Semi_Mono_DETR(BaseModel):
    ...
    def forward(self, inputs, calibs, targets, info, mode):
        ...
        if mode == 'loss':
            ...
            if self.pseudo_label_group_num == 1:
                ...
                cls_pseudo_targets_list, cls_mask, cls_cls_score = self.get_pseudo_targets_list(dets, calibs, dets.shape[0],
                                                                                            self.cfg["semi_train_cfg"][
                                                                                                "cls_cls_pseudo_thr"],
                                                                                            self.cfg["semi_train_cfg"][
                                                                                                "cls_score_pseudo_thr"],
                                                                                            self.cfg["semi_train_cfg"].get("cls_depth_score_thr",0)
                                                                                            )

                regression_pseudo_targets_list,regression_mask, regression_cls_score= self.get_pseudo_targets_list(dets, calibs, dets.shape[0],
                                                                                            self.cfg["semi_train_cfg"][
                ...
                mask_pseudo_targets_list, mask_mask, mask_cls_score=self.get_pseudo_targets_list(dets, calibs, dets.shape[0],
                                                                                            self.cfg["semi_train_cfg"][
                                                                                                "mask_cls_pseudo_floor"],
                                                                                            self.cfg["semi_train_cfg"][
                                                                                                "mask_score_pseudo_floor"],
                                                                                            self.cfg["semi_train_cfg"].get("mask_depth_score_floor",0),
                                                                                            self.cfg["semi_train_cfg"][
                                                                                                "mask_cls_pseudo_ceiling"],
                                                                                            self.cfg["semi_train_cfg"][
                                                                                                "mask_score_pseudo_ceiling"],
                                                                                            self.cfg["semi_train_cfg"].get("mask_depth_score_ceiling",0)
                                                                                            )                
    ...
    def get_pseudo_targets_list(self, batch_dets, batch_calibs, batch_size, cls_pseudo_thr, score_pseudo_thr, depth_score_thr,\
                                cls_pseudo_thr_ceiling=10000, score_pseudo_thr_ceiling=10000, depth_score_thr_ceiling=10000):
        pseudo_targets_list = []
        mask_list = []
